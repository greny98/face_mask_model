...
class AnchorBoxesLarge:
    def __init__(self):
        ...
        step = int((0.9 * IMAGE_SIZE_LARGE - 24) / 4)
        self._areas = [(x * step + 24) ** 2 for x in range(5)]
...
# ======================================================================================================================
class LabelEncoderLarge:
    def __init__(self):
        self._anchor_boxes = AnchorBoxesLarge()
